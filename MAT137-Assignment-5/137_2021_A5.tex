...
Consider the following two claims:	
	...
	\begin{enumerate}
		...
		\begin{align*}
		    ...
		    &=\lim_{x \to \infty}(\frac{x}{x})+\lim_{x \to \infty}(\frac{\cos{x}}{x})\quad(\mbox{By Limit Law of Sum})
		\end{align*}
		...
		We can calculate that $\lim_{x \to \infty}-\frac{1}{x}=\lim_{x \to \infty}\frac{1}{x}=0$. By Squeeze Theorem, we know that $\lim_{x \to \infty}(\frac{\cos{x}}{x})=0$. Thus,
		$$
