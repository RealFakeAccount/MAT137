...
\item We continue with the assumptions, notation and definitions as in Question \ref{likes}.
	...
	\begin{enumerate}
		...
		$$
		This is FALSE. To show it, we need to prove,
		$$
		    f\ loves\ g\ and\ g\ loves\ h\ AND\ f\ doesn't\ love\ h
		$$
		Take $f=\sin{x}$, $g=\frac{1}{2}$, $h=\sin{x}+\frac{1}{2}$. By definition to prove $f\ loves\ g$,
		$$
		    \M{g}{h} = \{x \in \R : \; \sin(x) < \frac{1}{2} \} = \{s \in \Z : (\frac{5}{6}+2s)\pi < x < (\frac{13}{6}+2s)\pi\}
		$$
		$$
		    \M{f}{g} = \{y \in \R : \; \frac{1}{2} < \sin(x) \} = \{t \in \Z : (\frac{13}{6}+2t)\pi < y < (\frac{17}{6}+2t)\pi\}
		$$
