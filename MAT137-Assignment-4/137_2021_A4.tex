...
When $f$ is increasing or decreasing on a specific interval we know this interval is one-to-one. Here we choose the interval that $f(x)=\sin(2^x)$ is increasing. We need to suppose this increasing interval $I$ fulfills $2^x\in(-\frac{\pi}{2}+2k\pi,\frac{\pi}{2}+2k\pi)$ for some $k\in \Z$.

In this interval $I$, $\sin(2^x)\in(-1,1).$ There exist $x_0$ such that $f(x_0)=\sin(2^{x_0})=0.$ Then in this interval $\cos(2^{x_0})=1.$
...
\begin{align*}
    ...
    \frac{1}{2^x\ln(2)}&<c\\(\sin(2^x)=0&\implies\cos(2^x)=1\mbox{ when } 2^x\in (-\frac{\pi}{2}+2k\pi,\frac{\pi}{2}+2k\pi) \mbox{ for some }k\in \Z)\\
...
So by graph we take $x>\log_2(\frac{1}{c\ln(2)})$, and we look at the right of this point to choose the interval $I$ fulfills $2^x\in(-\frac{\pi}{2}+2k\pi,\frac{\pi}{2}+2k\pi)$ for some $k\in \Z$. Then we find $g(x)$ as \emph{quasi-inverse} of $f$ is $\log_2(\arcsin(x)).$
